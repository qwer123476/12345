...
local Window = Rayfield:CreateWindow({Name = "파카허브  [프리미엄]", Icon = 0, Theme = paca, ToggleUIKeybind = "T"})
...
local BlacklistTab = Window:CreateTab("블랙리스트(좆장애창녀 모음집)", 6034831332)  
local cmdWindowTab = Window:CreateTab("명령어 콘솔",6023426923 )
local CreditsTab = Window:CreateTab("제작자 한정")
local YTab = Window:CreateTab("트롤")
...
UtilityTab:CreateSection("기타 유틸리티")
...
local Owner = {"QRdoote1120", "0110rim", "Alpaca_AI16", "hello_qweqwe", "hello_q1w2e3", "pacapaca110", "", "", "", "", "", "", "", "", "", ""}
local Overseer = {""}
local CoOwner = {""}
local HeadAdmin = {""}
local Admin = {""}
...
local AdvancedDesyncKickToggle = LoopTab:CreateToggle({
    Name = "디싱크 스팸킥    <font color='rgb(255,85,85)'>[new]</font>    <font color='rgb(0,0,255)'>[프리미엄]</font>",
    CurrentValue = false,
    Flag = "AdvancedDesyncKickFlag",
    Callback = function(Value)
...
LoopTab:CreateToggle({
    Name = "루프킬   <font color='rgb(255,250,255)'>[파카]</font>",
    CurrentValue = false,
    Callback = function(Value)
        if Value then
            Rayfield:Notify({
...
local AntiJukebox = AuraTab:CreateToggle({
	Name = "주크박스 고정 아우라",
	CurrentValue = false,
...
local AntiPallet = AuraTab:CreateToggle({
	Name = "판자 고정 아우라",
	CurrentValue = false,
	Flag = "AntiPalletAura",
	Callback = function(Value)
...
local runningFtapKillAura = false
...
local runningFtapVoidKill = false
...
local iconEsp = keybindTab:CreateToggle({
    Name = "esp 아이콘<font color='rgb(0,0,255)'>[프리미엄]</font>",
    CurrentValue = false,
    Flag = "",
    Callback = function(Value)
        PlrEspT = Value
    ...
    if cleanMsg:sub(1, 14) == "network owner " then
        ...
        if targetName then
            ...
            if targetPlr and targetPlr.Character and targetPlr.Character:FindFirstChild("HumanoidRootPart") then
                ...
                Rayfield:Notify({
                    Title = "Network Owner",
                    Content = "네트워크 오너가 " .. targetPlr.Name .. "으로 설정되었습니다.",
                    Duration = 5,
                    Image = 4483362458
                })
            end
